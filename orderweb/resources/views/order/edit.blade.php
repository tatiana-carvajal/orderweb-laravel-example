                            ...
                            <div class="col-lg-6">
                                ...
                                <table id = "table_data"class = "table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                No existen acitividades disponibles
                                            </td>
                                            ...
                                            @else
                                                 @foreach ($availableActivities as $activity)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href ="{{ route('order.remove_activity', [$order['id'], $activity->id]) }}" class="btn btn-primary btncinrcle bt-sm" tittle="Agregar">
                                ...
                                <label for="table_data">Actividades agregadas</label>
                                 <table id = "table_data"class = "table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                No existen acitividades agregadas
                                            </td>
                                            ...
                                            @else
                                                 @foreach ($availableActivities as $activity)
                                                    <tr>
                                                        ...
                                                        <td>{{ $activity->hours }}</td>
                                                        <td>
                                                            <a href ="{{ route('order.add_activity', [$order['id'], $activity->id]) }}" class="btn btn-danger btncinrcle bt-sm" tittle="Agregar">
